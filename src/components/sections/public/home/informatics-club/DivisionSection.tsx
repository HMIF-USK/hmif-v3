  ...
  return (
    <div className="w-full text-white bg-black">
      ...
      <section
        ...
        style={{
          background: 'linear-gradient(180deg, #450099 0%, #14031F 90%, #000000 100%)',
        }}
      >
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="mt-6 text-5xl md:text-6xl font-bold tracking-tight">What We Do?</h1>

          <p className="mt-4 max-w-xl text-lg leading-relaxed text-white/75">
            Three specialized divisions covering the full spectrum of modern technology.
          </p>
        </div>
      </section>

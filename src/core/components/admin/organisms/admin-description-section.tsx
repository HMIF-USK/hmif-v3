...
export default function AdminDescriptionSection({
  ...
  const highlightGradient = "linear-gradient(180deg,rgba(255,255,255,.12),rgba(255,255,255,0) 150px)";
    ...
    <section className="relative w-full overflow-visible rounded-[20px]">
      ...
      <div 
        ...
        style={{ 
          ...
          WebkitMaskImage: "radial-gradient(circle at bottom right, transparent 19px, black 19.5px)",
      ...
      <div className="absolute top-0 left-0 right-[260px] bottom-0 rounded-l-[20px] border-t border-l border-b pointer-events-none" style={{ borderColor: "#E19FFF" }} />

      {/* 2. Main Right-Top Border */}
      <div className="absolute top-0 right-0 w-[260px] bottom-[116px] rounded-tr-[20px] border-t border-r pointer-events-none" style={{ borderColor: "#E19FFF" }} />

      {/* 3. Outer Corner at (W, H-96) */}
      <div className="absolute right-0 bottom-[96px] w-[20px] h-[20px] rounded-br-[20px] border-r border-b pointer-events-none" style={{ borderColor: "#E19FFF" }} />

      {/* 4. Outer Corner at (W-240, H) */}
      <div className="absolute right-[240px] bottom-0 w-[20px] h-[20px] rounded-br-[20px] border-r border-b pointer-events-none" style={{ borderColor: "#E19FFF" }} />

      {/* 5. Notch Inner Corner & Edges Border */}
      <div className="absolute right-[20px] bottom-[20px] w-[220px] h-[76px] rounded-tl-[20px] border-t border-l pointer-events-none" style={{ borderColor: "#E19FFF" }} />

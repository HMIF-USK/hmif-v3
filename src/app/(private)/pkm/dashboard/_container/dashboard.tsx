...
export default function PkmDashboardContainer() {
  ...
  return (
    <InitScreen
      title="PKM Dashboard"
      description="Halaman dashboard PKM pribadi. Tekan tombol untuk mengaktifkan handler."
    >
      <button
        type="button"
        onClick={handleInit}
      ...
      {isReady ? (
        <p className="mt-4 text-sm text-emerald-300">Handler PKM berhasil diaktifkan.</p>
      ) : null}
    </InitScreen>
  );
}

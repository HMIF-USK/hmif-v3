...
export default function DashboardContainer() {
  ...
  return (
    <InitScreen
      title="PPM Dashboard"
      description="This private PPM dashboard section is under construction. Use the handler button below to initialize the screen."
    >
      <button
        type="button"
        onClick={handleInit}
      ...
      {isReady ? (
        <p className="mt-4 text-sm text-emerald-300">Handler PPM berhasil diaktifkan.</p>
      ) : null}
    </InitScreen>
  );
}

...
export default function DphDashboardContainer() {
  ...
  return (
    <InitScreen
      title="DPH Dashboard"
      description="Halaman dashboard DPH pribadi. Tekan tombol untuk mengaktifkan handler."
    >
      <button
        type="button"
        onClick={handleInit}
      ...
      {isReady ? (
        <p className="mt-4 text-sm text-emerald-300">Handler DPH berhasil diaktifkan.</p>
      ) : null}
    </InitScreen>
  );
}
